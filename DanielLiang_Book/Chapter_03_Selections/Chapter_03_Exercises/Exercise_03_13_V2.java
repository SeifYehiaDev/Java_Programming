...
public class Exercise_03_13_V2 {
    ...
    public static double taxForSingle(final double income) {
        ...
        if (income > 8_350)
            tax += (income < 33_950) ? (income - 8_350) * 0.15 : 3_840;
        if (income > 33_950)
            tax += (income < 82_250) ? (income - 33_950) * 0.25 : 12_075;
        if (income > 82_250)
            tax += (income < 171_550) ? (income - 82_250) * 0.28 : 25_004;
        if (income > 171_550)
            tax += (income < 372_950) ? (income - 171_550) * 0.33 : 66_462;
        if (income > 372_950)
    ...
    public static double taxForMarriedJointly(final double income) {
        ...
        if (income > 16_700)
            tax += (income < 67_900) ? (income - 16_700) * 0.15 : 7_680;
        if (income > 67_900)
            tax += (income < 137_050) ? (income - 67_900) * 0.25 : 17_287.5;
        if (income > 137_050)
            tax += (income < 208_850) ? (income - 137_050) * 0.28 : 20_104;
        if (income > 208_850)
            tax += (income < 372_950) ? (income - 208_850) * 0.33 : 54_153;
        if (income > 372_950)
            tax += (income - 372_950) * 0.35;
        return tax;
    }
    ...
    public static double taxForMarriedSeparately(final double income) {
        ...
        if (income > 8_350)
            tax += (income < 33_950) ? (income - 8_350) * 0.15 : 3_840;
        if (income > 33_950)
            tax += (income < 68_525) ? (income - 33_950) * 0.25 : 8_643.75;
        if (income > 68_525)
            tax += (income < 104_425) ? (income - 68_525) * 0.28 : 10_052;
        if (income > 104_425)
            tax += (income < 186_475) ? (income - 104_425) * 0.33 : 27_076.5;
        if (income > 186_475)
    ...
    public static double taxForHousehold(final double income) {
        ...
        if (income > 11_950)
            tax += (income < 45_500) ? (income - 11_950) * 0.15 : 5_032.5;
        if (income > 45_500)
            tax += (income < 117_450) ? (income - 45_500) * 0.25 : 17_987.5;
        if (income > 117_450)
            tax += (income < 190_200) ? (income - 117_450) * 0.28 : 20_370;
        if (income > 190_200)
            tax += (income < 372_950) ? (income - 190_200) * 0.33 : 60_307.5;
        if (income > 372_950)
            tax += (income - 372_950) * 0.35;
        return tax;
    }
