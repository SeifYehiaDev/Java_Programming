...
public class Exercise_03_08 {
    public static void main(String[] args) {
        ...
        if (secondNumber > thirdNumber) secondNumber = (secondNumber + thirdNumber) - (thirdNumber = secondNumber);
        if (firstNumber > secondNumber) firstNumber = (firstNumber + secondNumber) - (secondNumber = firstNumber);
...
//                                                 _Output_
/*
Enter three integers: 100 90 80
After sorting in non-decreasing order: 80 90 100
 */